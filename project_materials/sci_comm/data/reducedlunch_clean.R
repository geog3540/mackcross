...
df <- read_csv("Documents/research/primate_map/project_materials/sci_comm/data/reducedmeals.csv")
...
my_shapefile <- readOGR(dsn = "Documents/research/primate_map/project_materials/sci_comm/shapefiles/original_Iowa/IowaCounties.shp")
